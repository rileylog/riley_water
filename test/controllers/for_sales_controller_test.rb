...
class ForSalesControllerTest < ActionController::TestCase
  ...
  test "should create for_sale" do
    assert_difference('ForSale.count') do
      post :create, for_sale: { area_id: @for_sale.area_id, description: @for_sale.description, source: @for_sale.source, transferable_to: @for_sale.transferable_to, volume: @for_sale.volume }
    end
  ...
  test "should update for_sale" do
    patch :update, id: @for_sale, for_sale: { area_id: @for_sale.area_id, description: @for_sale.description, source: @for_sale.source, transferable_to: @for_sale.transferable_to, volume: @for_sale.volume }
    assert_redirected_to for_sale_path(assigns(:for_sale))
  end
