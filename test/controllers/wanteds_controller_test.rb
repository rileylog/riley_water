...
class WantedsControllerTest < ActionController::TestCase
  ...
  test "should create wanted" do
    assert_difference('Wanted.count') do
      post :create, wanted: { area_id: @wanted.area_id, description: @wanted.description, source: @wanted.source, volume: @wanted.volume }
    end
  ...
  test "should update wanted" do
    patch :update, id: @wanted, wanted: { area_id: @wanted.area_id, description: @wanted.description, source: @wanted.source, volume: @wanted.volume }
    assert_redirected_to wanted_path(assigns(:wanted))
  end
