...
(function() {
  $(function() {
    var area, displayArea, map, mapOptions, myParser, polygons, removeHighlighted, selected, setHighlighted, setListings, setListingsByTransferable, _i, _len, _ref;
    polygons = [];
    selected = 0;
    ...
    setListings = function() {
      var area, for_sale, for_sales, polygon, wanted, wanteds, _i, _j, _k, _l, _len, _len1, _len2, _len3, _ref, _ref1, _ref2;
      wanteds = [];
      for_sales = [];
      ...
      if (wanteds.length > 0) {
        ...
        $('#wanted').html((function() {
          var _len4, _m, _results;
          _results = [];
          for (_m = 0, _len4 = wanteds.length; _m < _len4; _m++) {
            wanted = wanteds[_m];
            _results.push("<div class='panel radius'><h5>" + wanted.volume + " ac-ft</h5><p>" + wanted.source + " | " + wanted.description + "</p></div>");
          }
          return _results;
        })());
      } else {
        $('#wanted').html("<div class='panel radius'><p>No wanted listings for this area.</p></div>");
      }
      if (for_sales.length > 0) {
        ...
        return $('#for_sale').html((function() {
          var _len4, _m, _results;
          _results = [];
          for (_m = 0, _len4 = for_sales.length; _m < _len4; _m++) {
            for_sale = for_sales[_m];
            _results.push("<div class='panel radius'><h5>" + for_sale.volume + " ac-ft | $" + for_sale.price + "/ac-ft</h5><p>" + for_sale.source + " | " + for_sale.description + " | Transferable to: " + for_sale.transferable_to + "</p></div>");
          }
          return _results;
        })());
      } else {
        return $('#for_sale').html("<div class='panel radius'><p>No for sale listings for this area.</p></div>");
      }
    };
    setListingsByTransferable = function(selected, area_name) {
      var for_sale, for_sales, _i, _j, _len, _len1, _ref, _ref1;
      for_sales = [];
      if (area_name === "All") {
        _ref = gon.for_sales;
      ...
      if (for_sales.length > 0) {
        return $('#for_sale').html((function() {
          ...
          _results = [];
          for (_k = 0, _len2 = for_sales.length; _k < _len2; _k++) {
            for_sale = for_sales[_k];
            _results.push("<div class='panel radius'><h5>" + for_sale.volume + " ac-ft | $" + for_sale.price + "/ac-ft</h5><p>" + for_sale.source + " | " + for_sale.description + " | Transferable to: " + for_sale.transferable_to + "</p></div>");
          }
          return _results;
        })());
      } else {
        return $('#for_sale').html("<div class='panel radius'><p>No for sale listings are transferable to that area.</p></div>");
      }
    };
    displayArea = function(doc) {
      ...
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        ...
        if (doc[0].url === area.kml.url) {
          ...
          _results.push(polygons.push(doc[0].placemarks[0].polygon));
        } else {
    ...
    return $('#transferable_to_area_name').change(function() {
      return setListingsByTransferable(selected, $("#transferable_to_area_name :selected").text());
    });
  });
...
(function() {
  $(function() {
    var map, mapOptions, marker, ourLoc;
